...
['month' => now()->startOfMonth()->monthName,
    'year' => now()->year, 'type' => 'ATTENDANCE REPORT']])
    <div style="font-size: 9pt;" >
        ...
        <table width="100%" style="border-spacing: 0;">
            ...
            <tr>
                ...
                <th style="border:1px solid #000; text-align: center;padding: 4px;"  colspan="31">Attendance Days</th>
            </tr>
            </thead>
            <tbody>
